...
<?php
  ...
  list($fname, $lname, $email, $addr1, $addr2, $city, $state, $zip, $phoneNO) = mysql_fetch_row($result);
    ...
    echo "<input type=\"text\" name=\"firstname\"  maxlength=\"20\" value=$fname required><br />";

    echo "<label for=\"lastname\">Last name:</label>";
    echo "<input type=\"text\" name=\"lastname\" value='$lname' maxlength=\"20\" required><br />";

    echo "<label for=\"addr1\">Address Line 1</label>";
    echo "<input type=\"text\", name=\"addr1\", value='$addr1', maxlength=\"50\" required><br />";

    echo "<label for=\"addr2\">Address Line 2</label>";
    echo "<input type=\"text\", name=\"addr2\", maxlength=\"50\", value='$addr2' /><br />";
    ...
    echo "<input type=\"text\" name=\"phone\"  maxlength=\"12\" value='$phoneNO' required><br />";
