...
<head>
  ...
  <title>Thank you for choosing GW!</title>
...
<body>
  ...
  <form method="post" action="account_success.php">
    ...
    <input type="text" name="addr1"  maxlength="50" required><br />
    <label for="addr2">Address Line 2</label>
    <input type="text" name="addr2"  maxlength="50" /><br />
    ...
    <input type="text" name="email1" required> @ <input type="text" name="email2" required> . <input type="text" name="email3"  maxlength="3" required>
