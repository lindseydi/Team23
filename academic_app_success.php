...
<?php
  ...
  $progarm = $_POST['program'];
 

  $query ="INSERT INTO application (studentNO, fname, lname, transcript_recv, starting_sem, prior_degree, pr_school, pr_GPA, pr_year, prior_degree2, pr_school2, 
    pr_GPA2, pr_year2, GRE_analytical, GRE_quant, GRE_verbal, GRE_subj1, GRE_subj2, prior_work1, prior_work2, interest, rec_email, rec_full_name, program, date_submitted)
  VALUES
  ('$studentNO',
   '$firstname', 
   '$lastname',
